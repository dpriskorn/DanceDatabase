...
DANCE_PROP_FACEBOOK_USER_ID = "P47"
DANCE_PROP_FACEBOOK_GROUP_ID = "P48"
DANCE_PROP_FACEBOOK_PAGE_ID = "P49"

# URLs
DANCE_PROP_WEBSITE = "P12"
...
DUPLICATE_CHECK_PROPERTIES = [
    "DANCE_PROP_WIKIDATA",
    "DANCE_PROP_BYGDEGARDARNA_ID",
    "DANCE_PROP_FOLKETSHUS_ID",
    "DANCE_PROP_SPELPLAN_ID",
    "DANCE_PROP_FACEBOOK_USER_ID",
    "DANCE_PROP_FACEBOOK_GROUP_ID",
    "DANCE_PROP_FACEBOOK_PAGE_ID",
    "DANCE_PROP_WEBSITE",
]